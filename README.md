...
- [FlightPath Data](https://www.flightpathdata.com) - FlightPath sits in front or integrated within a data lake's bronze layer to protect it from invalid external data file feeds as a trusted publisher 
