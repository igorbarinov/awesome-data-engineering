...
- [Gumroad Marketplace Snapshot](https://github.com/sujeito-operator/gumroad-market-data) - 9,617 listing observations covering 8,311 digital products from 4,532 sellers across 255 Gumroad categories, August 2026. Prices normalised to USD; 316 listings publish a real unit-sales count rather than a ratings proxy. CSV, CC BY 4.0, scraper included.
- [VS Code Marketplace Installs](https://github.com/sujeito-operator/vscode-marketplace-data) - 64,490 VS Code extensions from 50,468 publishers with real install counts rather than a proxy, 5,688,542,991 installs represented. Collected from the Marketplace's own public extensionquery API, August 2026. CSV and JSONL, CC BY 4.0, collector included.
