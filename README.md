...
* [Quix.io](https://quix.io/product/for-data-processing-pipelines/) A serverless platform for deploying and running Python projects that need to process high-frequency data streams (such as sensor data or other time-series data) in real time with nano-second precision.
