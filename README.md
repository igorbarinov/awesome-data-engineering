...
- [JobsPipe](https://jobspipe.dev) - Jobs data API: live postings from 30+ ATS feeds and job boards, deduplicated and normalized to one JSON schema, with job.created and job.closed webhooks and a company tech-stack scanner for enrichment pipelines.
